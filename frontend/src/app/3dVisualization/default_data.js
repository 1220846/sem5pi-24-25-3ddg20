...
export const mazeData = {
    url: "https://localhost:5001/api/hospitals",
...
export const cameraData = {
    ...
    initialOrientation: new Orientation(180.0, -90.0), // Horizontal and vertical orientation and associated limits (expressed in degrees)
